...
class Auth0JwtDecoderTest {
    ...
    private static final String TEST_ISSUER =
            "https://dev-zg0aldkj2slve32o.us.auth0.com/";

    private static final String TEST_AUDIENCE =
            "https://huella360-api";

    private static final String HMAC_SECRET =
            "VGhpcyBpcyBhIHNlY3JldCBrZXkgZm9yIHRlc3RpbmcgMTIzNDU2Nzg5";
    ...
    void decodeLegacyToken_withHmacSecret_textPlain() {
        String plainSecret =
                "This-is-a-secret-key-for-testing-12345678";

        Auth0JwtDecoder plainDecoder =
                new Auth0JwtDecoder(
                        "https://example.com/",
                        "https://example-api",
                        plainSecret
    ...
    void decodeLegacyToken_invalidSignature_throwsJwtException() {
        String otherSecret =
                "VGhpcyBpcyBhbm90aGVyIHNlY3JldCBrZXkgZm9yIHRlc3RpbmcgMTIzNDU2Nzg5";

        byte[] otherBytes =
                Base64.getDecoder().decode(otherSecret);

        SecretKey otherKey =
                Keys.hmacShaKeyFor(otherBytes);
    ...
    void decodeLegacyToken_preservesAllClaims() {
        ...
        assertEquals(
                "15",
                jwt.getClaimAsString("empresaId")
        );
    }
    ...
    @Test
    void constructor_blankIssuer_throwsIllegalArgumentException() {
        assertThrows(
                IllegalArgumentException.class,
                () -> new Auth0JwtDecoder(
                        "   ",
    ...
    @Test
    void constructor_blankAudience_throwsIllegalArgumentException() {
        assertThrows(
                IllegalArgumentException.class,
                () -> new Auth0JwtDecoder(
                        "https://example.com/",
